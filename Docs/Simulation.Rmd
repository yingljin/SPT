...
- $t = 0.2, 0.4, 0.6, 0.8, 1$
- $\xi_{ik}, \xi'_{ik}$ are indenpendently generated from $N(0, 1)$
...
- For now we ignore random effects across space. Consider only fixed effects
...
# Example 2: Moving average error in Y2

- What if we introduce a spatial MA error in Y2? 
